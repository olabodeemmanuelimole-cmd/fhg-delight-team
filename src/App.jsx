...
function ModulePage({ type, onBack, onNavigate, onSelectOffice, onSelectMember, onReviewPlan, onEditOrder, selectedOfficeId, selectedMemberId, user }) {
...
function FormPage({ type, onBack, selectedPlanId, selectedOrderId, user }) {
