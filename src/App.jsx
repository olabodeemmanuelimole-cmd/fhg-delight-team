...
function ModulePage({ type, onBack, onNavigate, onSelectOffice, onSelectMember, onSelectBook = bookId => { window.sessionStorage.setItem('teamflowSelectedBook',bookId); onNavigate('bookdetail') }, onReviewPlan, onEditOrder, onEditFinance, onViewFinanceHistory, selectedOfficeId, selectedMemberId, selectedBookId, selectedTransactionId, user }) {
  ...
  const filterable = ['activity','orders','weeklyorders','plans','books','attendance','withdrawals','team','announcements','feedback','events','notifications','adminnotifications','members','attendanceregister','transferapprovals','feedbackinbox','admindashboard','offices','leaders','orgmembers','transfers','reports','teamreports','auditlog','pointsettings'].includes(type)
...
function AppShell({ user }) {
  ...
  const leaderPages = new Set(['leaderdashboard','weeklyorders','members','transferapprovals','teamreports','feedbackinbox','attendanceregister','bookreview','excusereview','planreview'])
  ...
  const navigate = destination => {
    const fullLeaderOnly = new Set(['members','transferapprovals','teamreports','feedbackinbox','bookreview','excusereview','planreview'])
